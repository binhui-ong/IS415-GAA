...
In this exercise, we will be exploring the geographical and spatio-temporal distribution of Grab hailing services locations in Singapore with the use of spatial point patterns analysis techniques.

## 1.3 Our Task

-   Use appropriate functions of **sf** and **tidyverse** to prapre the following geospatial data layer in sf tibble data.frames:
...
```{r}
#|eval: FALSE
pacman::p_load(tidyverse, sf, spatstat, raster, maptools, tmap, arrow, spNetwork, classInt, viridis)
```
