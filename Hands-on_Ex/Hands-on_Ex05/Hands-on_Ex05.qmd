...
In this exercise, we will learning how to compute Global Measures of Spatial Autocorrelection (GMSA) and Local Measures of Spatial Autocorrelation using the **spdep** package.
...
# 3 Global Measures of Spatial Autocorrelation (GMSA)
...
## 3.2 Row-standarized weights matrix
